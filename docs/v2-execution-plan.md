...
当前状态（2026-08-09）：Phase 0 已完成；Phase 1 的数据库与采集开发项已完成，连续影子验收留到 MHR-7；Phase 2 已完成 15m/1h/4h/24h 收益率、数据质量门禁、五分钟计算流水线和幂等特征快照。jmk 实算 716 个合约时有 2,860 个有效周期、4 个零流动性周期被排除；下一批进入 Crypto/TradFi 分板块稳定 Top N。
